...
const Banner = () => {
    ...
    />    
      ...
      <Carousel.Caption>
              <Bounce left cascade>
              <h3 className="text-primary display-5 fw-bold ">We always put the patients first</h3>
      ...
      <div className=" d-flex justify-content-center ">      
       ...
       alt="Second slide"
         ...
         <Carousel.Caption>
         <Bounce left cascade>
                   <h3 className="text-primary display-5 fw-bold">To take care of your health</h3>
           <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
          </Bounce>
           <div className=" d-flex justify-content-center ">      
                     <Bounce>
      ...
      />
       <Carousel.Caption>
       <Bounce left cascade>
       <h3 className="text-primary display-5 fw-bold">First slide label</h3>
       <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
       </Bounce>
       <div className=" d-flex justify-content-center ">      
                <Bounce>
